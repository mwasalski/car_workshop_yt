...
def generate_dims(save_fn, scale=1.0):
    ...
    # managers exist now -> backfill locations.manager_id
    ...
    save(df_locations, 'locations')
    save(df_employees, 'employees')
    ...
    save(pd.DataFrame(products), 'products')
